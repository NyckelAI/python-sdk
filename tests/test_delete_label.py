from nyckel import TextClassificationFunction, ClassificationLabel, TextClassificationSample, ClassificationAnnotation
...
def test_simple(text_classification_function, auth_test_user):
    ...
    samples_with_annotation = [sample for sample in samples if sample.annotation]
    assert "Nice" not in [sample.annotation.label_name for sample in samples_with_annotation]
